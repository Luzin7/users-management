...
exports.ListInactivesUsersService = void 0;
...
let ListInactivesUsersService = class ListInactivesUsersService {
    userRepository;
    ...
    async execute({ pagination }) {
        ...
        const { users, total } = await this.userRepository.findInactive(Number(pagination.page), Number(pagination.limit));
...
exports.ListInactivesUsersService = ListInactivesUsersService;
exports.ListInactivesUsersService = ListInactivesUsersService = __decorate([
